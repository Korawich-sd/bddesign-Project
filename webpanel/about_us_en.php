    ...
    <div class="layout-pages">
        <div class="box-title">
            ...
            <div class="box-add-blog">
                <a href="about_us.php"><button class="btn-blog-th">เพิ่มข้อมูลฉบับภาษาไทย</button></a>
            </div>
        </div>
        <div class="title-box">
            <?php
            for ($i = 0; $i < count($row_about_us); $i++) {
                ...
                <p><?php echo $row_about_us[$i]['title'] ?> <a href="edit_title_about_us_en.php?topic_id=<?php echo $row_about_us[$i]["id"] ?>"><?php if ($row_about_us[$i]["title"] == null) {
                                                                                                                                                    echo "";
                                                                                                                                                } else {
                                                                                                                                                    echo "แก้ไขที่นี่";
                                                                                                                                                } ?></a></p>
                <h4><?php echo $row_about_us[$i]['topic'] . "   " ?><a href="edit_about_us_en.php?topic_id=<?php echo $row_about_us[$i]["id"] ?>"><button class="btn btn-warning"><i class="bi bi-pencil-square"></i></button></a></h4>
