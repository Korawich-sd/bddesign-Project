	...
	<main>
		...
		<section id="page-section">
			<div class="container-xxl">
				...
				<h4>รับเขียนแบบบ้าน ออกแบบบ้าน</h4>

				



				<p>บริการยื่นขออนุญาต ยื่นกู้ธนาคาร ตลอดจนกระบวนการก่อสร้างที่ได้
มาตรฐานตามหลักวิศวกรรม โดยมีวิศวกรควบคุม มีการรับประกันหลัง
ส่งมอบบ้าน แม้ว่าจะเป็นการสร้างบ้านหลังแรกหรือหลังที่เท่าไหร่ เราก็มี
ทีมงานคุณภาพที่พร้อมให้คำปรึกษาเหมือนเป็นทีมก่อสร้างของคุณเอง</p>
					...
					<?php for($i=1;$i<=3;$i++){ ?> 
						<div class="col-6 col-md-4">
							<div class="view-seventh mb-4">
								<a href="upload/g0<?=$i?>.webp" class="b-link-stripe b-animate-go thickbox" title="รับเขียนแบบบ้าน ออกแบบบ้าน">
									<div class="box-gallery">
										<div class="bg-img">
											<img class="img-fluid" src="upload/g0<?=$i?>.webp" alt="รับเขียนแบบบ้าน ออกแบบบ้าน">
										</div>
